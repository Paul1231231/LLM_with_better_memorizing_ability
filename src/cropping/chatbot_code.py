...
def summarize(question, answer):
    ...
    """
    system_prompt = (
        "From the provided question and answer, extract only user purpose, useful information and code snippets for future conversation."
        "Remove explanations and commentary."
        "Especially focus on the user provided code and information"
    )
...
df.to_csv("crop_code_1.csv", index=False)
